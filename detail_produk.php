...
<body>
    ...
    <div class="container-fluid bg-primary py-1 bg-header" style="margin-bottom: 90px;">
        ...
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-4 text-white animated zoomIn">Detail</h1>
    ...
    <div class="row">
        <div class="col-lg-6">
            <?php foreach ($produkfoto as $key => $value):?>
                ...
                <img src="assets/foto_produk/<?php echo $value['nama_produk_foto'];?>" alt="Product Image" class="img-fluid stretched-img">
                <!-- Tambahan gambar produk lainnya atau slider -->
            </div>
            <?php endforeach ?>
           
        </div>
        <div class="col-lg-6 detail-form">
            <div class="post">
                <div class="card">
                    <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input disabled type="number" name="stok" class="form-control" value="<?php echo $produk['stock_produk']; ?>">
                        </div>
                    </div>
                    <br>
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Your Site Name</a>. All Rights Reserved.
                            ...
                            Designed by <a class="text-white border-bottom" href="https://htmlcodex.com">Rizki Septian</a>
                        </p>
